...
namespace Question2
{
    ...
    {
        private static int s_mNumber = 300;
        ...
        public Eco(FuleType fuleType, int numberOfSeats, string color, int tankCapacity, int numberOfKmDriven, string brandName, string modelName, string engineNumber, string chasisNumber) : base(fuleType, numberOfSeats, color, tankCapacity, numberOfKmDriven)
        {
